            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    try {
                        ...
                        ResultSet resultSet = selectStatement.executeQuery("SELECT * FROM regdoctors");

                        while (resultSet.next()) {
                            String currentName = resultSet.getString("name");
                            String currentEmail = resultSet.getString("email");
                            String currentHospitalName = resultSet.getString("hospitalname");
                            String currentAddress = resultSet.getString("address");
                            String currentAadhar = resultSet.getString("aadhar");
                            String currentPwd = resultSet.getString("pwd");
                            String currentSpecialization = resultSet.getString("specialization");
                    ...
                    %>
                            <tr>
                                <td><%= currentName %></td>
                                <td><%= currentEmail %></td>
                                <td><%= currentHospitalName %></td>
                                <td><%= currentAddress %></td>
                                <td><%= currentAadhar %></td>
                                <td><%= currentPwd %></td>
                                <td><%= currentSpecialization %></td>
                                ...
                                <td>
                                    ...
                                    <form action="ddelete.jsp" method="post" onsubmit="return confirm('Do you want to delete this data?');">
